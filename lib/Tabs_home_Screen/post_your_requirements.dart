...
class _PostYourRequirementsState extends State<PostYourRequirements> {
  ...
  List searchStateItems = [];
  @override
  void initState() {
    // searchStateItems = stateitems;
    super.initState();
    fetchUser();
  }
  ...
  void searchStateFilter(String enteredkeyword) {
    print(enteredkeyword);

    if (enteredkeyword.isEmpty) {
      //if the search field is empty or only contains white-space, we will display
      setState(() {
        results = stateitems;
      });
    } else {
      List searchList = stateitems.where((item) {
        return item.toLowerCase().contains(enteredkeyword.toLowerCase());
      }).toList();
      setState(() {
        results = searchList;
